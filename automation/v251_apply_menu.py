...
ENTRY_PATH = ROOT / "menu_games_entry_v251.json"
...
def main() -> None:
    ...
    if changed:
        ...
        print("[PATCH] content/menu.json -> Game Objects Test (V2.25.1)")
    else:
        print("[OK] content/menu.json already labels Game Objects Test (V2.25.1)")
